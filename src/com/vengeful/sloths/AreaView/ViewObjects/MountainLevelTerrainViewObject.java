 ...
 */
public class MountainLevelTerrainViewObject extends ViewObject {
    private DynamicImage grassImage;
    public MountainLevelTerrainViewObject(int r, int s, CoordinateStrategy coordinateStrategy, LocationStrategy locationStrategy, String xmlPath) {
